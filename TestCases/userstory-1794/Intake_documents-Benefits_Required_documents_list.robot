...
Resource        C:/Users/Bhanu.Battu/PycharmProjects/TestProject/Resources/LoginPageKeywords.robot
...
#    capture page screenshot     RU-1.png
#    close browser
##
Test case_Verify the Benefits & Required documents list in Documents screen, if benefits selected from calim determination screen - Provider
    [Tags]    DEBUG
    open browser       https://htcinc-cloud.caretech.com/cvcs/portal/#/cz/login  chrome
    maximize browser window
    capture page screenshot
    ...
    enter r&r informetion and click on next
    select Benefits in Claim determination Information and Click on Next
    capture page screenshot     PROV1.png
#    close browser

#Test case_Verify the Benefits & Required documents list in Documents screen, if benefits selected from calim determination screen - Advocate
#    [Tags]    DEBUG
#    open browser       https://htcinc-cloud.caretech.com/cvcs/portal/#/cz/login  chrome
#    maximize browser window
#    capture page screenshot
...
#    enter r&r informetion and click on next
#    select Benefits in Claim determination Information and Click on Next
#    capture page screenshot     Advct1.png
#    close browser

#Test case_Verify the Benefits & Required documents list in Documents screen, if benefits selected from calim determination screen - CV Staff_Analyst
#    [Tags]    DEBUG
#    open browser       https://htcinc-cloud.caretech.com/cvcs/portal/#/cz/login  chrome
#    maximize browser window
#    capture page screenshot
...
#    enter r&r informetion and click on next
#    select Benefits in Claim determination Information and Click on Next
#    capture page screenshot     CV_STAFF_ANALYST1.png
#    close browser
#
#
#Test case_Verify the Benefits & Required documents list in Documents screen, if benefits selected from calim determination screen - CV Staff_Tech
#    [Tags]    DEBUG
#    open browser       https://htcinc-cloud.caretech.com/cvcs/portal/#/cz/login  chrome
#    maximize browser window
#    capture page screenshot
...
#    enter r&r informetion and click on next
#    select Benefits in Claim determination Information and Click on Next
#    capture page screenshot     CV_STAFF_TECHNICIAN.png
#    close browser
...
Enter Victim Informetion and Click on Next
    ...
    input text      id:middlename       Sprint2
    input text      id:firstname        CVStaff 829-Comp claim
